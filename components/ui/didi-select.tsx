        ...
        >
          {placeholder && (
            <li
              ...
              className="px-4 py-3 cursor-pointer text-muted hover:!bg-white hover:!text-purple-600 dark:hover:!bg-white dark:hover:!text-purple-600"
            >
              {placeholder}
            </li>
          )}
          {options.map((opt) => (
            <li
              ...
              className="px-4 py-3 cursor-pointer text-foreground dark:text-white hover:!bg-white hover:!text-purple-600 dark:hover:!bg-white dark:hover:!text-purple-600"
            >
              {opt.label}
            </li>
          ))}
