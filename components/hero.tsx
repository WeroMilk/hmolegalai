...
export function Hero() {
  ...
  return (
    <section className="relative flex justify-center pt-20 sm:pt-0 pb-6 sm:pb-14 sm:min-h-[calc(100svh-72px)] sm:items-center">
      <div className="relative z-10 max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 text-center w-full min-w-0">
        ...
        >
          ...
          <p className="text-[1.02rem] xs:text-base sm:text-xl md:text-2xl text-muted mb-4 xs:mb-6 md:mb-12 max-w-3xl mx-auto px-1 xs:px-4 leading-snug">
            {t("home_hero_subtitle")}
          </p>

          <div className="flex flex-col sm:flex-row gap-2 xs:gap-3 sm:gap-4 justify-center items-center mb-4 xs:mb-6 md:mb-14 px-0 xs:px-4">
            <Link
              href="/consulta"
          ...
          <div className="grid grid-cols-3 gap-2 xs:gap-3 sm:gap-10 md:gap-12 max-w-4xl mx-auto px-0 xs:px-2 sm:px-4 mt-2 xs:mt-3 sm:mt-12 md:mt-10">
            <motion.div
