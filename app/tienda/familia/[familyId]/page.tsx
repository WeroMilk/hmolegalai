          ...
          {products.map((product: Product, i: number) => (
            ...
            >
              <Link href={`/tienda/${product.slug}`} className="block">
                <div className="aspect-square relative border border-gray-200/50 dark:border-border overflow-hidden flex items-center justify-center bg-white">
                  <Image
                    src={product.image}
                    alt={product.name}
                    fill
              ...
              <div className="px-4 pb-4 flex items-center gap-2">
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-1.5 text-sm font-medium text-teal-600 dark:text-teal-400 hover:underline sm:justify-start sm:px-0 w-14 h-12 sm:w-auto sm:h-auto rounded-lg hover:bg-teal-500/10 sm:hover:bg-transparent"
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-1.5 text-sm font-medium text-muted hover:text-teal-600 dark:hover:text-teal-400 transition-colors sm:justify-start sm:px-0 w-14 h-12 sm:w-auto sm:h-auto rounded-lg hover:bg-teal-500/10 sm:hover:bg-transparent"
