              ...
              return (
                ...
                >
                  <Link href={`/tienda/familia/${fam.id}`} className="group flex flex-col flex-1">
                    <div className="relative aspect-[4/3] bg-white dark:bg-transparent border border-gray-200/50 dark:border-border flex items-center justify-center p-4 sm:p-6">
                      {hasImage ? (
                        <Image
                          src={fam.image!}
                          alt={fam.name}
